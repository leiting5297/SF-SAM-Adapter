...
#         cv2.imwrite('imgs.png',imgs)
#         cv2.imwrite('pred_masks.png',pred_masks)
#         cv2.imwrite('gt_masks.png',gt_masks)
...
#         cv2.imwrite('imgs.png',imgs[:row_num,:,:,:])
#         cv2.imwrite('pred_masks.png',pred_masks[:row_num,:,:,:])
#         cv2.imwrite('gt_masks.png',gt_masks[:row_num,:,:,:])
        # compose = torch.cat((imgs[:row_num,:,:,:],pred_disc[:row_num,:,:,:], pred_cup[:row_num,:,:,:], gt_disc[:row_num,:,:,:], gt_cup[:row_num,:,:,:]),0)
        compose = torch.cat(tup,0)
        
        vutils.save_image(imgs[:row_num,:,:,:],fp = save_path.split('.jpg')[0]+'imgs.png')
        vutils.save_image(pred_masks[:row_num,:,:,:],fp = save_path.split('.jpg')[0]+'pred.png')
        vutils.save_image(gt_masks[:row_num,:,:,:],fp = save_path.split('.jpg')[0]+'gt.png')
